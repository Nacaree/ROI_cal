...
function MetricsGrid({ results }) {
  // This card explains how the required rent was derived from the selected target mode.
  ...
  // Match the icon direction to the revenue gap sign, not just the color.
  const RevenueGapIcon = isRevenueGapPositive ? TrendingUp : TrendingDown
